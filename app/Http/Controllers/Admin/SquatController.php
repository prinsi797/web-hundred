...
use App\Models\AppUserSquat as Table;
use App\Models\AppUser;
use App\Http\Requests\AppUserSquatsRequests\UpdateSquats as UpdateRequest;
use App\Http\Requests\AppUserSquatsRequests\AddSquats as AddRequest;
use Exception;
use Illuminate\Support\Carbon;

class SquatController extends Controller
{
    protected $handle_name = "app user squats";
    protected $handle_name_plural = "squats";
    ...
    {
        try {
            $squats = Table::where('id', '=', $request->id)->first();
            $squats = Table::findOrFail($request->id);
            $users = AppUser::get();
