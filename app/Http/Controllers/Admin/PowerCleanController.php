...
use App\Models\AppUserPowerclean as Table;
use App\Models\AppUser;
use App\Http\Requests\AppUserPowercleansRequests\UpdatePowerCleans as UpdateRequest;
use App\Http\Requests\AppUserPowercleansRequests\AddPowerCleans as AddRequest;
use Exception;
use Illuminate\Support\Carbon;

class PowerCleanController extends Controller
{
    protected $handle_name = "app User powercleans";
    protected $handle_name_plural = "powercleans";
    ...
    {
        try {
            $powercleans = Table::where('id', '=', $request->id)->first();
            $powercleans = Table::findOrFail($request->id);
            $users = AppUser::get();
