...
use App\Models\AppUserBenchpress as Table;
use Exception;
use App\Http\Requests\AppUserBenchpressRequests\UpdateBenchpress as UpdateRequest;
use App\Http\Requests\AppUserBenchpressRequests\AddBenchpress as AddRequest;
use Illuminate\Support\Carbon;

class BenchPressController extends Controller
{
    protected $handle_name = "app user benchpress";
    protected $handle_name_plural = "benchpress";
    ...
    {
        try {
            $benchpress = Table::where('id', '=', $request->id)->first();
            $benchpress = Table::findOrFail($request->id);
            $users = AppUser::get();
