...
use App\Models\Feedback as Table;
use App\Models\AppUser;
use App\Http\Requests\AppUserFeedbacksRequests\UpdateFeedbacks as UpdateRequest;
use App\Http\Requests\AppUserFeedbacksRequests\AddFeedbacks as AddRequest;
use Carbon\Exceptions\Exception;
use Illuminate\Support\Carbon;

class FeedbackController extends Controller
{
    protected $handle_name = "app user Feedbacks";
    protected $handle_name_plural = "app_user_feedbacks";
    ...
    {
        try {
            $feedbacks = Table::where('id', '=', $request->id)->first();
            $feedbacks = Table::findOrFail($request->id);
            $users = AppUser::get();
