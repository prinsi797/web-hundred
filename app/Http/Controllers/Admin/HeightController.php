...
use App\Models\AppUserHeight as Table;
use App\Models\AppUser;
use App\Http\Requests\AppUserHeightsRequests\UpdateHeights as UpdateRequest;
use App\Http\Requests\AppUserHeightsRequests\AddHeights as AddRequest;
use Exception;
use Illuminate\Support\Carbon;

class HeightController extends Controller
{
    protected $handle_name = "app user heights";
    protected $handle_name_plural = "app_user_heights";
    ...
    {
        try {
            $heights = Table::where('id', '=', $request->id)->first();
            $heights = Table::findOrFail($request->id);
            $users = AppUser::get();
