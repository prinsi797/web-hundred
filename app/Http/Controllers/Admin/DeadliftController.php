...
use App\Models\AppUserDeadlift as Table;
use App\Models\AppUser;
use App\Http\Requests\AppUserDeadliftsRequests\UpdateDeadlifts as UpdateRequest;
use App\Http\Requests\AppUserDeadliftsRequests\AddDeadlifts as AddRequest;
use Exception;
use Illuminate\Support\Carbon;

class DeadliftController extends Controller
{
    protected $handle_name = "app user deadlifts";
    protected $handle_name_plural = "deadlifts";
    ...
    {
        try {
            $deadlifts = Table::where('id', '=', $request->id)->first();
            $deadlifts = Table::findOrFail($request->id);
            $users = AppUser::get();
