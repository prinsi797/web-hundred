                                    ...
                                    <div class="row">
                                                ...
                                                <select name="app_user_id" class="form-control change_advertiser" required
                                                    ...
                                                    @foreach ($users as $user)
                                                        <option value="{{ $user->id }}"
                                                            @if ($edit && $data->id == $user->id) selected @endif>
                                                            {{ $user->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="date" type="text" placeholder="Choose date" class="form-control datepicker"
                                                 name="date" @if ($edit) value="{{ $dates->isEmpty() ? old('date') : $dates->first() }}" @else value="{{ old('dates') }}" @endif 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="bench_press" type="text" placeholder="Enter Bench Press"
                                                    ...
                                                    @if ($edit) value="{{ $benchpress->isEmpty() ? old('bench_press') : $benchpress->first() }}" @else value="{{ old('bench_press') }}" @endif
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="deadlift" type="text" placeholder="Enter Deadlift"
                                                    class="form-control" name="deadlift"
                                                    @if ($edit) value="{{ $deadlifts->isEmpty() ? old('deadlift') : $deadlifts->first() }}" @else value="{{ old('deadlift') }}" @endif
                                                    autocomplete="deadlift" autofocus>
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="power_clean">Power Clean</label>
                                                <input id="power_clean" type="text" placeholder="Enter Power Clean"
                                                    class="form-control" name="power_clean"
                                                    @if ($edit) value="{{ $powerCleans->isEmpty() ? old('power_clean') : $powerCleans->first() }}" @else value="{{ old('power_clean') }}" @endif
                                                    autocomplete="power_clean" autofocus>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="squat" type="text" placeholder="Enter Squat"
                                                    class="form-control" name="squat"
                                                    @if ($edit) value="{{ $squats->isEmpty() ? old('squat') : $squats->first() }}" @else value="{{ old('squat') }}" @endif
                                                    autocomplete="power_clean" autofocus>
                                            </div>
                                        </div>
                                    </div>
