                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="inch" type="text" placeholder="Enter inch"
                                                    class="form-control" name="inch"
                                                    @if ($edit) value="{{ $data->inch }}" @else value="{{ old('inch') }}" @endif
                                                    autocomplete="inch" autofocus>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="fit" type="text" placeholder="Enter fit"
                                                    class="form-control" name="fit"
                                                    @if ($edit) value="{{ $data->fit }}" @else value="{{ old('fit') }}" @endif
                                                    autocomplete="fit" autofocus>
                                            </div>
                                        </div>
